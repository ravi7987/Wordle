...
export class SettingsRepository {
    ...
    public async updateNumberOfattempts(
        ...
        try {
            ...
            const result = await SettingsModel.findByIdAndUpdate(id, {
     ...
     * @returns response
     */
    public async updateCandidates(id: string, candidates: string[]): Promise<IRepoResponse<any>> {
        try {
            let response: IRepoResponse<any> = {} as IRepoResponse<any>;
     ...
     * @returns response
     */
    public async updateAnswer(id: string, answer: string): Promise<IRepoResponse<any>> {
        try {
            let response: IRepoResponse<any> = {} as IRepoResponse<any>;
    ...
    /**
     * @description updates the temperory candidates list for advanced wordle
     * @param id @description _id of the document
     * @param tempList @description temporaray list of candidates selected from candidates @type string[]
     * @returns response
     */
    public async updateTempCandidatesList(
        id: string,
        tempList: string[],
    ): Promise<IRepoResponse<any>> {
        try {
